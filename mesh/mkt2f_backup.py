        ...
        for elnum, elem in enumerate(t):
            ...
            for i, node in enumerate(elem): # The ith node in the element
                ...
                if idx == -1:
                    ...
                    opp_elnum = idx // (num_nodes_per_elem*3)    # magic number 3 is the number of face combintations per face - we didn't have this with line segment faces
...
if __name__ == '__main__':
    ...
    mesh = load_processed_mesh('../data/3D/h0.1_tets4686.npy')
    f, t2f = mkt2f_new(mesh['t'], 3)