...
def test_3d_cube_sine_homoegeneous_dirichlet(porder, meshfile, solver):
    ...
    exact = domain_helper_fcns.exact_sine_cube(mesh['pcg'])[:,None]
    grad_exact = domain_helper_fcns.grad_sine_3d(mesh['pcg'], m=1)
...
if __name__ == '__main__':
    ...
    # print(test_3d_cube_sine_homoegeneous_dirichlet(2, 'cube24', 'direct'))
    # print('porder', 2, 'cube100', 'direct')
    # print(test_3d_cube_sine_homoegeneous_dirichlet(2, 'cube100', 'gmres'))
    # print('porder', 2, 'cube4591', 'gmres')
    # print(test_3d_cube_sine_homoegeneous_dirichlet(2, 'cube4591', 'gmres'))

    # print('porder', 3, 'cube24', 'direct')
    # print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube24', 'direct'))
    # print('porder', 3, 'cube24', 'cg')
    # print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube24', 'cg'))
    # print('porder', 3, 'cube100', 'gmres')
    # print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube24', 'gmres'))

    print('porder', 3, 'cube100', 'direct')
    print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube100', 'direct'))
    print('porder', 3, 'cube100', 'cg')
    print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube100', 'cg'))
    print('porder', 3, 'cube100', 'gmres')
    print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube100', 'gmres'))

    print('porder', 3, 'cube4591', 'cg')
    print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube4591', 'cg'))
    print('porder', 3, 'cube4591', 'gmres')
    print(test_3d_cube_sine_homoegeneous_dirichlet(3, 'cube4591', 'gmres'))