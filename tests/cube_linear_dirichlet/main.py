...
def test_3d_cube_linear_dirichlet(porder, meshfile, solver):
    ...
    exact = domain_helper_fcns.exact_linear(mesh['pcg'], 'x')[:,None]
    grad_exact = domain_helper_fcns.grad_linear_solution(mesh['pcg'], 'x')
...
if __name__ == '__main__':
    ...
    print(test_3d_cube_linear_dirichlet(2, 'cube24', 'direct'))
    print('porder', 2, 'cube100', 'direct')
    print(test_3d_cube_linear_dirichlet(2, 'cube100', 'gmres'))
    print('porder', 2, 'cube4591', 'gmres')
    print(test_3d_cube_linear_dirichlet(2, 'cube4591', 'gmres'))

    print('porder', 3, 'cube24', 'direct')
    print(test_3d_cube_linear_dirichlet(3, 'cube24', 'direct'))
    print('porder', 3, 'cube24', 'cg')
    print(test_3d_cube_linear_dirichlet(3, 'cube24', 'cg'))
    print('porder', 3, 'cube24', 'gmres')
    print(test_3d_cube_linear_dirichlet(3, 'cube24', 'gmres'))

    print('porder', 3, 'cube100', 'direct')
    print(test_3d_cube_linear_dirichlet(3, 'cube100', 'direct'))
    print('porder', 3, 'cube100', 'cg')
    print(test_3d_cube_linear_dirichlet(3, 'cube100', 'cg'))
    print('porder', 3, 'cube100', 'gmres')
    print(test_3d_cube_linear_dirichlet(3, 'cube100', 'gmres'))

    print('porder', 3, 'cube4591', 'cg')
    print(test_3d_cube_linear_dirichlet(3, 'cube4591', 'cg'))
    print('porder', 3, 'cube4591', 'gmres')
    print(test_3d_cube_linear_dirichlet(3, 'cube4591', 'gmres'))